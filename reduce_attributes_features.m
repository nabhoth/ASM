...
inpath = '/mnt/images/2/VOC2012/Regions/JPEGImages/%s';
...
ins = 'Features_Hypothesis_Regions_Mapping_BN.mat';
...
if bins > 0
	outs = ['Features_Hypothesis_Regions_Mapping_BN_%d_reduced_' removal '.mat'];
	outs = sprintf(outs, bins);
else
	outs = ['Features_Hypothesis_Regions_Mapping_BN_NOBINS_reduced_' removal '.mat'];
	outs = sprintf(outs, bins);
end
