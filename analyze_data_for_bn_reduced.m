function [suitability, im_accumulators, rows,  ent_results,  per_results, classes_cat, c_mu, a_mu, a_cov, c_cov,results, full_results, ful_results,norm_results,norm_results_s, max_vals] = analyze_data_for_bn_reduced(bins, removal, threshold, minmax, reduce)
...
%     end
    ...
    save(['./data/from_whole_images_best_analysis/norm_results_cont' '.mat'], 'norm_results_s', '-v7.3');
